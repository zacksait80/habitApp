...
import 'package:kodu_ko/components/name_page_bottom_sheet.dart';
import 'package:kodu_ko/models/task.dart';
import 'package:kodu_ko/utils/duration_to_string.dart';
import 'package:kodu_ko/utils/parse_duration.dart';
...
class _CreateTaskBottomSheetState extends State<CreateTaskBottomSheet> {
  ...
  Duration customTime = const Duration(minutes: 35);
  String? _value;
  int? _selectedColor;
  int pageIndex = 0;
